...
import copy
import math
from model.util import gelu
from model.util import get_shape_list
from model.util import get_activation
from model.util import create_initializer
from model.util import reshape_to_matrix
from model.util import reshape_from_matrix
    ...
    def __init__(self,
        ...
        with tf.variable_scope(scope, default_name="TextEncoder"):
            with tf.variable_scope("embeddings"):
                embedding_table_shape = get_shape_list(embedding_table, expected_rank=2)
                tf.logging.info("Encoder embedding table shape:%s"%(str(embedding_table_shape)))
